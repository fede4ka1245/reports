...
const cachedRequestInstructors = cachedRequest(getInstructors, storageKey.instructors);
...
const cachedRequestExpensesCategories = cachedRequest(getExpenseCategories, storageKey.expensesCategories);
